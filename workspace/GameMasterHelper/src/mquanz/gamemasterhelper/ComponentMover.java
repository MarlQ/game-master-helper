...
public class ComponentMover extends MouseAdapter {
	...
	private MapObjectIcon destination;
	private MapObjectIcon source;

	private Point pressed;
	private Point location;
	GUIDrawingSurface parentPanel;
	 ...
	 */
	public ComponentMover(GUIDrawingSurface parentPanel) {
	...
	public void deregisterComponent(MapObjectIcon... components) {
		for (MapObjectIcon component : components)
